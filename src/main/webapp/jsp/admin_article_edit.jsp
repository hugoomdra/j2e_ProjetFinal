                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <select name="type">
                                ...
                                <option ${article.type == "PS4" ? "selected" : ""} value="">PS4</option>
                        ...
                        <div class="col-12 mt-3">
                            <p><textarea required name="description" cols="30" rows="10" placeholder="Description de l'article">${article.description}</textarea></p>
                        </div>
